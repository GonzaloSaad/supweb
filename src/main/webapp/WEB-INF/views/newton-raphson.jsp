...
<body>
 <!-- Page header wrapper -->
        <div class="header">
            ...
            <h1 class = "header-block"><a href="${pageContext.request.contextPath}/home">Matematica Superior<a> > Newton-Raphson</h1>
        </div>
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class = "actual" href="${pageContext.request.contextPath}/newton-raphson">Newton-Raphson</a>
                </li>
                <li>
